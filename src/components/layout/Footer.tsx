        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <MotionDiv variants={footerItem}>
              <h3 className="text-lg font-semibold text-gray-900 mb-6">Hubungi Kami</h3>
              <address className="space-y-4 not-italic">
                <div className="flex items-start">
                  <svg className="h-5 w-5 text-lisma mt-1 mr-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg>
                  <div className="text-gray-600">
                    <p>Jl. Tamansari No. 6-8</p>
